...
The following example works on any version of *mzXML* and works similarly for *mzML* (doesn't support mzXML 3.1 compression just yet).
...
mzData support to be re-included in the future.
